...
public class LoginService {
    ...
    public Map<String, String> login(LoginDto loginDto) {
        ...
        try {
            ...
            Integer userId = usersMapper.loginRow(loginDto.getLoginId());

            System.out.println("debug >>>> loginAvailable " + userId);

            if (userId > 0) {

                // 2. 사용자 정보 조회
                UserDataDto user = usersMapper.compareLoginInfoRow(userId);
